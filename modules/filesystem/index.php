...
$usedspace = dirsize($home_path);
	...
	/*case ''  : $sql .= " and l.active = 'yes' "; break;
		case 'A' : $sql .= " and l.active = 'yes' and l.lastinserted > ".$lastpludta; break;
		case 'U' : $sql .= " and l.active = 'yes' and l.lastupdated > ".$lastpludta; break;*/
