<?php
    ...
    if (!$saction){
        ...
        ?>
            ...
            <center>
            <b>האם ברצונך להוציא  תשלום מאפס חוב אוטומטי לכל הלקוחות המסומנים?</b>
            <br><br>
                תאריך תשלום
                    ...
                    <input type=button value='סגור' onclick='window.returnValue=-1;window.close()'>
            </form>
        <?
    ...
    else
    {
        ...
        $comment = "תשלום איפוס אוטומטי, נוצר ".date("d/m/Y");
        $paymenttype = "1";
        $cnt=0;
        ...
        echo "<center><BR><p style='color:green;font-size:12pt;font-weight:bold'>הפעולה הסתימה בהצלחה</p>
        <b>מספר תשלומים שנוצרו: $cnt</b>
        <BR><BR><input type=button onclick='window.close()' value='סגור'></p><center>";
