...
if ($_GET["usr"]||$_POST["usr"]){
	...
	$GO_MODULES->authenticate('credit_admin');
...
$HasWritePermissions = $GO_MODULES->has_write_permission($userID,"credit");
...
$config['baseurl'] = $GO_CONFIG->protocol.$GO_CONFIG->hostname.'/modules/credit';
...
$config['basepath'] = $GO_CONFIG->root_path.'modules/credit';
...
//mask is drisha~eska~category~type (note: from right to left in hebrew! ייי - is a mask (any value)
...
$config['export_categories'] = array(
		...
		"ייי~ייי~עסקים~ייי"=>56,

		"ייי~ייי~מגרשים~ייי"=>57,

		"ייי~מכירה~מגורים~ייי"=>24,

		"ייי~השכרה~מגורים~ייי"=>25
...
$UserData->fields["EnableNewKupaInCredit"] = 1;
