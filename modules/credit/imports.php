    ...
    <table cellpadding=5 border=0 width=100%>
        ...
        <form name=F  onsubmit='return validate();' method=post action='importclients.php?simple=1&action=do&rmodule=<?=$rmodule?>' encType=multipart/form-data target=log>
              <tr>
                ...
                <td>
                    <input checked type=radio onclick='chMode("i")' name=mode value=i onclick='sswitch(1)'><?=$lang['import']?>
                    <input type=radio name=mode onclick='chMode("e")' value=e onclick='sswitch(2)'><?=$lang['export']?>
                </td>
            </tr>
            <tr>
            ...
            <tr id=OPTIONS style='display:none'>
                ...
                <td>
                    <input type='checkbox' name=translit>להפוך רוסית לאנגלית
                    <?if (false)
                    {?>
            ...
            <tr id=OPTIONS1 style='display:none'>
                <td height=37  bgcolor=#efefef nowrap>אפשרויות</td>
                <td>
                    <input type='checkbox' name=update>לעדכן לקוחות קיימים 
                    <?if (false)
                    {?>
                    &nbsp;<input type='checkbox' name=forcepriceupdate>לעדכן מכיר בכל נקודות המכירה
                        <?}?>
