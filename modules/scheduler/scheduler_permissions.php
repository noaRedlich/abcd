...
if ($post_action == 'read')
{
	...
	$read_tab = true;
	$acl_control_id="read";
	$acl_control_acl_id = $scheduler["acl_read"];
	if ($scheduler['user_id'] != $GO_SECURITY->user_id)
	{
...
}else
{
	...
	$acl_control_acl_id = $scheduler["acl_write"];
	if ($scheduler['user_id'] == $GO_SECURITY->user_id)
	{
...
<tr>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td colspan="99" class="TableHead"><?php echo $scheduler['name']; ?></td>
			</tr>
			<tr>
				<td class="<?php if(isset($read_tab)) echo 'ActiveTab'; else echo 'Tab'; ?>" align="center" width="100"><a href="<?php echo $PHP_SELF; ?>?post_action=read&scheduler_id=<?php echo $scheduler_id; ?>" class="<?php if(isset($read_tab)) echo 'ActiveTab'; else echo 'Tab'; ?>"><?php echo $strReadRights; ?></a></td>
				<td class="<?php if(isset($write_tab)) echo 'ActiveTab'; else echo 'Tab'; ?>" align="center" width="100"><a href="<?php echo $PHP_SELF; ?>?post_action=write&scheduler_id=<?php echo $scheduler_id; ?>" class="<?php if(isset($write_tab)) echo 'ActiveTab'; else echo 'Tab'; ?>"><?php echo $strWriteRights; ?></a></td>
