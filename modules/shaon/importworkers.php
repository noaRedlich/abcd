...
elseif ($action=="do")
{
    ...
    {
  		echo "<a target=_blank href='".$rootpath."importworkers.php?action=dat&auto=$auto&stock=$stock&sDate=$sDate&eDate=$eDate&username=$username&uid=$userID&rnd=".rand()."'><strong>{$lang['click_to_download']} <span dir=ltr>time.csv</span></strong></a><br>";
    }
