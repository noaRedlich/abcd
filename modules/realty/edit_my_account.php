<?php
	...
	else
	{
		...
		$sql = "SELECT f.field_name, db.field_value, f.field_type, f.rank, f.field_caption, f.default_text, f.required, f.field_elements FROM userFormElements f left join UserDBElements db on db.field_name = f.field_name and db.user_id = '$userID' ORDER BY f.rank";
