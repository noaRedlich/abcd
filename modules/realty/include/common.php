<?php
	...
	$GO_MODULES->authenticate('realty');
	...
	$config['baseurl'] = $GO_CONFIG->protocol.$GO_CONFIG->hostname.'/modules/realty';
	...
	$config['basepath'] = $GO_CONFIG->root_path.'modules/realty';
	$config['admin_name'] = 'Ryan Bonham'; // Your name -- all email will come from this name
	$config['admin_email'] = 'ryan@open-realty.org'; // all email which is sent from the site will come from this address
