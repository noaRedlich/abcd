...
include("$config[template_path]/admin_top.html");
	...
	while (!$recordSet->EOF)
		...
		echo "<p align=\"center\"><a href=\"$PHP_SELF?action=delete_pic&edit=$edit&pic_id=$pic_id\" onClick=\"return confirmDelete()\">".$lang[delete]."</p>";
		...
		echo "<table border=\"0\">";
		echo "<tr><td  class=\"image_row_$count\"><b>$lang[admin_template_editor_field_rank]:</b></td><td ><input type=\"text\" name=\"rank\" value=\"$rank\"><div class=\"small\">$lang[upload_rank_explanation]</div></td></tr>";
		echo "<tr><td  class=\"image_row_$count\"><b>$lang[upload_caption]:</b></td><td ><input type=\"text\" name=\"caption\" value=\"$caption\"></td></tr>";
		echo "<tr><td  class=\"image_row_$count\"><b>$lang[upload_description]:</b><td ><textarea name=\"description\" rows=\"6\" cols=\"40\">$description</textarea></td></tr>";
		echo "<tr><td align=\"center\"  class=\"image_row_$count\" colspan=\"2\"><input type=\"submit\" value=\"".$lang[save]."\">";
		echo "</form></td></tr>";
		echo "</table>";
