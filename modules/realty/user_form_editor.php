<?php
	...
	?>
		...
		<h3><?php echo $lang[admin_template_editor_user_form_editor_name] ?></h3>
		</td></tr>
		<form action="<?php $php_self ?>" method="post">
		<input type="hidden" name="action" value="makeNewElement">
		<tr>
			<td colspan="2" class="templateEditorHead"><?php echo $lang[admin_template_editor_add_a_new_form_item] ?>:</td>
		</tr>
		<tr> 	
		...
		<tr>
			<td align="left" class="templateEditorNew"  valign="top">&nbsp;<input type="submit" name="Submit" value="<?php echo $lang[admin_template_editor_add_a_new_form_item] ?>"></td>
		...
		<tr>
			<td colspan="2" class="templateEditorHead"><?php echo $lang[admin_template_editor_form_builder] ?>:</td>
		</tr>
		...
		while (!$recordSet->EOF)
		{
			...
			<tr><td colspan=2 class="row_main" align="left"><?php echo $lang[admin_template_editor_field] ?>: <?php print $count ?></td></tr>
			<tr> 
				<td align="right" class="row_main" valign="top"><b><?php echo $lang[admin_template_editor_field_name] ?>:</b></td>
				<td class="row_main" align="left"><input type=text name="field_name" value="<?php print $field_name ?>"></td>
			</tr>
		
			<tr> 
				<td align="right" class="row_main" valign="top"><b><?php echo $lang[admin_template_editor_field_type] ?>:</b></td>
				<td class="row_main" align="left">
				 <select name="field_type" size="1">
					<OPTION VALUE="<?php print $field_type ?>" SELECTED><?php print $field_type ?></OPTION>
					<OPTION VALUE="">-----</OPTION>
			...
			<tr> 
				<td align="right" class="row_main" valign="top"><b><?php echo $lang[admin_template_editor_field_required] ?>:</b></td>
				<td class="row_main" align="left">
				 <select name="required" size="1">
					<OPTION VALUE="<?php print $required ?>" SELECTED><?php print $required ?></OPTION>
					<OPTION VALUE="">-----</OPTION>
			...
			<tr> 
				<td align="right" class="row_main" valign="top"><b><?php echo $lang[admin_template_editor_field_caption] ?>:</b></td>
				<td class="row_main" align="left"><input type=text name="field_caption" value = "<?php print $field_caption ?>"></td>
			</tr>
			
			<tr> 
				<td align="right" class="row_main" valign="top"><b><?php echo $lang[admin_template_editor_field_elements] ?>:<BR><div class="small">(<?php echo $lang[admin_template_editor_choices_separated] ?>)</div></b></td>
				<td class="row_main" align="left"><input type=text name="field_elements" value = "<?php print $field_elements ?>"></td>
			</tr>
			
			<tr> 
				<td align="right" class="row_main" valign="top"><b><?php echo $lang[admin_template_editor_field_default_text] ?>:</b></td>
				<td class="row_main" align="left"><input type=text name="default_text" value = "<?php print $default_text ?>"></td>
			</tr>
			
			<tr> 
				<td align="right" class="row_main" valign="top"><b><?php echo $lang[admin_template_editor_field_rank] ?>:</b></td>
				<td class="row_main" align="left" ><input type=text name="rank" value = "<?php print $rank ?>"></td>
			</tr>
		
			<tr>
				<td align="right" class="row_main" valign="top">&nbsp;</td>
				<td class="row_main" align="left"><input type="submit" name="Submit" value="<?php echo $lang[update_button] ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $PHP_SELF ?>?action=DeleteUserFormElement&id=<?php print $id ?>" onClick="return confirmDelete()"><?php echo $lang[delete] ?></a></td>
			</tr></form>
