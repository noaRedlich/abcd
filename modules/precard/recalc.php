        ...
        <td width=100% align=center>
            ...
            <table>
                <tr>
                    ...
                    <td>&nbsp;<input size=6 name=sDate id=sDate value="<?= $sDate ?>">
                ...
                <tr>
                    ...
                    <td>&nbsp;<input size=6 name=eDate id=eDate value="<?= $eDate ?>">
                ...
                <tr>
                    ...
                    <td>&nbsp;<Input name=hSalary size=2 value="<?= ($hSalary) ? $hSalary : $worker->fields["HourSalary"] ?>"><?=$lang['nis']?>
                    </td>
                </tr>
            </table>

            <hr>
            <input type=submit value=" <?=$lang['submit']?> " style="cursor:hand;padding:0px 0px 0px 10px;background:url(<?= $imgPath ?>refresh.gif);background-repeat:no-repeat;background-position:left top">
            <input type=button onclick='window.close()' value=' <?=$lang['close_button']?> ' style="cursor:hand;padding:0 0 0 0;background:url(<?= $imgPath ?>refresh1.gif);background-repeat:no-repeat;background-position:left top">
