<?php
	...
	if ($edit == "")
	{
		...
		while (!$recordSet->EOF)
		{
			...
			<?php
			echo "<tr><td align=\"right\" width=\"200\" class=\"row1_$count\"><span class=\"adminListingLeft_$count\"><B>$lang[user_editor_user_number]: $edit_ID</b></span></td><td align=\"center\" class=\"row2_$count\" width=\"310\"> <B> <a href=\"$PHP_SELF?edit=$edit_ID\">$lang[user_editor_modify_user] </a></b></td><td width=\"120\" align=\"middle\" class=\"row2_$count\"><a href=\"$PHP_SELF?delete=$edit_ID\" onClick=\"return confirmUserDelete()\">$lang[user_editor_delete_user]</a></td></tr>";	
	...
	else
	{
		...
		<tr>
			<td width="<?php echo $style[image_column_width] ?>" valign="top" align="center" class="row_main">
				...
				<br>
				<hr width="75%">
				<a href="edit_user_images.php?edit=<?php echo $edit ?>"><?php echo $lang[edit_images] ?></a><br><br>
				<?php
		...
		$sql = "SELECT f.field_name, db.field_value, f.field_type, f.rank, f.field_caption, f.default_text, f.required, f.field_elements FROM userFormElements f left join UserDBElements db on db.field_name = f.field_name and db.user_id = '$edit' ORDER BY f.rank";
