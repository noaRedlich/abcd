...
<script language="JavaScript">
	...
	function sendColor()
	{
		if (document.all.col.value != '')
		{
			opener.iView.document.execCommand('<?php echo $set; ?>', false, document.all.col.value);
			opener.iView.focus();
			window.close();
		}
	}
...
<img src="<?php echo $GO_THEME->image_url ?>colors.gif" border="0" usemap="#colorMap">
<input type="text" name="col" style="width:185" style="height:22; font-family: verdana; font-size: 8pt">
<input onClick="sendColor()" type="submit" value="<?php echo $editor_select; ?>" style="height:22; font-family: arial; font-size: 8pt; border: 1px solid black; background-color: grey">
</body>
</html>
