...
function form($selected_id = "", $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1)
{
	...
	$combo_contract_id->Query = "select id, contract_number from realtycontracts order by contract_number";
	...
	$code .= "\n\t<tr><td class=TableHeader valign=top><div class=TableHeader style='text-align:right;'>Contract</div></td><td class=TableBody>$combo_contract_id->HTML&nbsp;&nbsp;</td></tr>";
	$code .= "\n\t<tr><td class=TableHeader valign=top><div class=TableHeader style='text-align:right;'>Payment Date</div></td><td class=TableBody><input size=10 type=text class=TextBox name=payment_date value='$row->payment_date'>&nbsp;&nbsp;</td></tr>";
	...
	$code .= "\n\t<tr><td class=TableHeader valign=top><div class=TableHeader style='text-align:right;'>Check Number</div></td><td class=TableBody><input size=10 type=text class=TextBox name=check_number value='$row->check_number'>&nbsp;&nbsp;</td></tr>";
	$code .= "\n\t<tr><td class=TableHeader valign=top><div class=TableHeader style='text-align:right;'>Bank</div></td><td class=TableBody><input size= 50 type=text class=TextBox name=check_bank value='$row->check_bank'>&nbsp;&nbsp;</td></tr>";
	$code .= "\n\t<tr><td class=TableHeader valign=top><div class=TableHeader style='text-align:right;'>Branch</div></td><td class=TableBody><input size= 50 type=text class=TextBox name=check_branch value='$row->check_branch'>&nbsp;&nbsp;</td></tr>";
