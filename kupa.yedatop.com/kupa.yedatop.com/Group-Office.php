...
if (false)//Server Offline
{
    ...
    <body>
        ...
        <center>
            <b style=\'color:red\'>
                ניתן להשתמש באתר רק ב-Internet Explorer גירסת 6.0 ומעלה
                <br>
                ���� �-3 ������
                ��� ����� 10:00 - 13:00
                <br>
                למידע נוסף נא לפנות לטל. 072-2125588
            </b>
        </center>
        <br>';
    exit();
...
class GO_CONFIG
{
    ...
    var $root_path = "/home/mlaitech/kupa.yedatop.com/";
    #temporary files ends with slash
    var $tmpdir = "/home/mlaitech/kupa.yedatop.com/tmp/";
    #path to images
    var $image_url = "http://kupa.yedatop.com/themes/blue-grey/images/";
    ...
    var $mime_types_file = '/etc/mime.types';
        var $file_storage_path = "/home/mlaitech/kupa.yedatop.com/officefiles/";
        var $transactions_path = "/home/mlaitech/kupa.yedatop.com/transactions/";
    ...
    function GO_CONFIG() {
        ...
        $this->protocol = $_SERVER["HTTPS"] ? "https://" : "https://";
        $this->host = $this->protocol . $this->hostname . "/";
        $this->root_path = $DOCUMENT_ROOT;

        if (substr($this->root_path,strlen($this->root_path)) != "/")
            $this->root_path .= "/";
        if (!$this->image_url)
            $this->image_url = $this->host . "themes/blue-grey/images/";
        //if($_GET['newskin']==1){
        $this->theme = 'blue';
...
# get translates from DB vcx000
require_once($GO_CONFIG->class_path . 'database_pdo.class.inc');
require_once($GO_CONFIG->class_path . 'translates.class.inc');
$translate = new Translate();
$lang = $translate->getAllTranslatesForLang(($GO_LANGUAGE->language) ? strtolower($GO_LANGUAGE->language) : 'english');

$def_charset="utf-8";
$direction = $lang['dir'];
unset($lang_modules);
$lang_modules['scheduler'] = $lang['mod_scheduler'];
$lang_modules['filesystem'] = $lang['mod_filesystem'];
$lang_modules['email'] = $lang['mod_email'];
$lang_modules['projects'] = $lang['mod_projects'];
$lang_modules['realty'] = $lang['mod_realty'];
$lang_modules['stock'] = $lang['mod_stock'];
$lang_modules['catalog_admin'] = $lang['mod_catalog_admin'];
$lang_modules['catalog'] = $lang['mod_catalog'];
$lang_modules['stock_admin'] = $lang['mod_stock_admin'];
$lang_modules['stock_reports'] = $lang['mod_stock_reports'];
$lang_modules['account'] = $lang['mod_account'];
$lang_modules['shaon'] = $lang['mod_shaon'];
$lang_modules['credit'] = $lang['mod_credit'];
$lang_modules['credit2'] = $lang['mod_credit2'];
$lang_modules['stock_pro'] = $lang['mod_stock_pro'];
$days =array(
    1=>$lang['sunday'],
    2=>$lang['monday'],
    3=>$lang['tuesday'],
